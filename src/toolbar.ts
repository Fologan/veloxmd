...
const ACTIONS: Record<string, (e: any) => void> = {
  ...
  link:          e => e.insertTemplate('[link text](url)'),
  image:         e => e.insertTemplate('![alt text](url)'),
